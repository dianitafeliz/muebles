...
return [
    ...
    */
    ...
    'min' => [
        'numeric' => 'El campo :attribute debe tener una longitud de al menos :min carácteres.',
        'file' => 'El campo :attribute must be at least :min kilobytes.',
        'string' => 'El campo :attribute debe tener una longitud de al menos :min carácteres.',
    ...
    'unique' => 'El valor de :attribute ya existe en la base de datos.',
